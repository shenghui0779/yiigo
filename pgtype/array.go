...
func (GenericArray) evaluateDestination(rt reflect.Type) (reflect.Type, func([]byte, reflect.Value) error, string) {
	...
	// TODO repeat this section on the element type of arrays or slices (multidimensional)
	{
		...
		assign = func([]byte, reflect.Value) error {
			return fmt.Errorf("pgtype: scanning to %s is not implemented; only sql.Scanner", rt)
		}
	}
...
func (a GenericArray) Scan(src interface{}) error {
	...
	case dpv.IsNil():
		return fmt.Errorf("pgtype: destination %T is nil", a.A)
	}
	...
	return fmt.Errorf("pgtype: cannot convert %T to %s", src, dv.Type())
}
...
func (a GenericArray) Value() (driver.Value, error) {
	...
	case reflect.Array:
	default:
		return nil, fmt.Errorf("pgtype: Unable to convert %T to array", a.A)
	}
